...
public class SinaBlogPipeline implements Pipeline {
    ...
    private static Logger logger = Logger.getLogger(SinaBlogPipeline.class);
    private Properties properties = new Properties();
    String temppath = "";
    String baseurl = "http://blog.sina.com.cn/";
    String imgparas = "";
    String errorsrc = "";
    ...
    public SinaBlogPipeline() {
        ...
        try {
            ...
            //e.printStackTrace();
            logger.error("Sina blog pipeline read config error!"+e);
        }
